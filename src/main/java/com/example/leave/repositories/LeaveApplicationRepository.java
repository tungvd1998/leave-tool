...
public interface LeaveApplicationRepository extends JpaRepository<LeaveApplication, Integer> {
    ...
    @Query(value = " SELECT SUM(leave_duration) " +
            ...
            " WHERE u.username = :username AND MONTH (from_date) = MONTH (to_date) AND MONTH (from_date) = :month", nativeQuery = true)
    Long calculateLeaveDurationByUsername(@Param("username") String username, @Param("month") Integer month);
